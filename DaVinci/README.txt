* API documentation included from DaVinci Resolve 1.18. However not everything is
* documented correctly. There are interfaces missing and extra ones that don't work
* The signatures and types aren't well defined
